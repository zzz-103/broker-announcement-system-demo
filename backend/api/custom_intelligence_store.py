            ...
            with self._connection() as connection:
                ...
                cursor = connection.execute(
                    ...
                    (
                        owner_user_id,
                        payload["name"],
                        payload.get("question", payload.get("focus", "")),
                        payload.get("description", payload.get("audience_detail", "")),
                        _json(payload.get("keywords", payload.get("focus_tags", []))),
                        _json(payload.get("focus_objects", [])),
                        payload.get("analysis_perspective", payload.get("audience", "research_business")),
                        ...
                        payload.get("extra_requirements", payload.get("extra_focus", "")),
