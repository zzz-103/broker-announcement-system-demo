...
2. 分类树强制枚举 (procurement_category & project_subcategory)：
   ...
   2.1 金融科技边界判断：
   - 先识别采购对象，再识别其服务的业务场景，最后单独判断采购动作。采购动作不是项目属性。
   - 如果采购对象是系统、平台、软件、数据、接口、数据库、应用、引擎或相关开发/实施服务，且明确服务于券商的风控、交易、行情、清算、投行、合规、客户渠道等金融业务，应归入 "IT软硬件"；通常二级选择 "业务系统与软件"。
   - "信创"、"国产化"、"适配"、"升级"、"改造"、"续签"、"续约"只描述技术背景或采购动作，不能单独把项目归为非金融科技，也不能覆盖其底层金融业务系统属性。
   - 证券公司的投行、资本市场、风控等业务名称，如果采购内容是业务系统或软件改造，不应因为出现“投行”“专业服务”字样而归入 "专业及金融服务"。
   - 只有法律、审计、管理咨询、人力、行政、物业、装修、保洁等非系统交付，或明确为通用后勤/办公采购时，才归入非 IT 类别。
   - 例如：联合风控系统信创适配升级、期货行情系统软件续签、投行质控内核改造，均属于金融业务系统，应归入 "IT软硬件/业务系统与软件"；“采购动作”分别独立填写升级改造、续采续约或其他适当枚举。
