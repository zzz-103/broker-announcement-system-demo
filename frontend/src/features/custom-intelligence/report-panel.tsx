    ...
    <section aria-label="情报报告" className="rounded-lg border border-[#E4EAF2] bg-white">
      <header className="sticky top-0 z-20 rounded-t-lg border-b border-[#E4EAF2] bg-white px-4 py-3 sm:px-5">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <ReportTemplateSwitcher value={templateStyle} onChange={onTemplateStyleChange} />
      ...
      <div className="px-4 py-5 sm:px-5">
        ...
        {!active && execution.status === "succeeded" && <div className="mt-1"><ReportBody execution={execution} templateStyle={templateStyle} /></div>}
      </div>
    </section>
  );
}
